...
public class Practice13GetTextBoundsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint2.getTextBounds(text2, 0, text1.length(), textBound);
        yOffsets[1] = -(textBound.top + textBound.bottom) / 2;

        paint2.getTextBounds(text3, 0, text1.length(), textBound);
        yOffsets[2] = -(textBound.top + textBound.bottom) / 2;

        paint2.getTextBounds(text4, 0, text1.length(), textBound);
        yOffsets[3] = -(textBound.top + textBound.bottom) / 2;

        paint2.getTextBounds(text5, 0, text1.length(), textBound);
        yOffsets[4] = -(textBound.top + textBound.bottom) / 2;

        paint2.getTextBounds(text6, 0, text1.length(), textBound);
