...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Bitmap bp1 = BitmapFactory.decodeResource(getResources(), R.drawable.batman);
        Shader shader1 = new BitmapShader(bp1, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Bitmap bp2 = BitmapFactory.decodeResource(getResources(), R.drawable.batman_logo);
        Shader shader2 = new BitmapShader(bp2, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
